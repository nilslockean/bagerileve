...
metaDescription: Denna integritetspolicy förklarar hur vi samlar in och använder dina personuppgifter.
edited: "2024-08-24"
---
...
Personuppgiftsansvarig är {contact.legalName}, organisationsnummer {contact.orgNumber}, {contact.address.street}, {contact.address.zip}, {contact.address.city} (benämns hädanefter som “Bolaget”). Bolaget driver hemsidan {config.siteUrl}.
...
### 1.1 { config.siteTitle }s kurser

Ändamål: För att kunna tillhandahålla { config.siteTitle }s kurser (benämns hädanefter som “Tjänsten”).

#### Kategorier av personuppgifter

Vi samlar in och behandlar följande kategorier av personuppgifter i samband med att du använder vår Tjänst: namn, telefonnummer och e-postadress.
...
Följande bolag kan komma att få tillgång till dina personuppgifter inom ramen för Tjänsten: Fienta (bokningssystem för kurser) och Kassacentralen (TrueORDER kassasystem vid beställning).
...
### 1.2 Beställning av varor

Ändamål: För att kunna tillhandahålla förbeställning av bland annat fredagsmunkar (benämns hädanefter som “Förbeställning”).

#### Kategorier av personuppgifter

Vi samlar in och behandlar följande kategorier av personuppgifter i samband med att du använder vår Förbeställning: e-postadress.

#### Personuppgiftsbehandlingar som utförs

Vi behandlar personuppgifterna på följande sätt: kontakt via e-post.
...
Följande bolag kan komma att få tillgång till dina personuppgifter inom ramen för Förbeställning: Kassacentralen (TrueORDER kassasystem vid beställning).

#### Laglig grund

Den legala grunden för personuppgiftsbehandlingen är fullgörande av avtal med dig som använder dig av Förbeställning.

#### Din rätt att motsätta dig behandlingen

Denna behandling av dina personuppgifter är nödvändig för att vi ska kunna fullgöra Förbeställning. Om du vill motsätter dig denna typ av behandling kan vi tyvärr inte erbjuda Förbeställning.

#### Lagringsperiod

Vi behandlar och lagrar dina personuppgifter för detta ändamål i upp till 3 år räknat från och med att kundens relation anses avslutad.

### 1.3 Marknadsföring

Ändamål: För att marknadsföra { config.siteTitle }s kurser.
...
Följande bolag kan komma att få tillgång till dina personuppgifter inom ramen för vår marknadsföring: MailerLite (e-posthanteringssystem)
...
Du kan ta tillbaka ditt samtycke genom att mejla din begäran till { config.contact.email }.
...
Vi värnar om din integritet och lovar att inte behandla dina personuppgifter för detta ändamål om du inte längre vill. Du motsätter dig behandlingen genom att mejla din begäran till { config.contact.email }
...
Du utövar dina rättigheter genom att mejla din begäran till { config.contact.email }.
...
Om du har frågor om vår behandling av personuppgifter går det bra att skicka ett e-postmeddelande till { config.contact.email }.
...
Denna integritetspolicy trädde i kraft { frontmatter.edited }.
